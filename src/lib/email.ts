        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(15,23,42,0.08);">
          ...
          <tr>
            <td dir="rtl" style="padding:32px 32px 8px;text-align:right;">
              <p style="margin:0 0 12px;color:#0F172A;font-size:17px;font-weight:700;line-height:1.7;">${greetingAr}</p>
              <p style="margin:0 0 20px;color:#334155;font-size:15px;line-height:1.9;">${bodyAr}</p>
            </td>
          </tr>
          <!-- CTA -->
          <tr>
            <td style="padding:8px 32px 8px;text-align:center;">
              <a href="${inviteUrl}"
                ...
                ${ctaAr}<br /><span style="font-size:13px;font-weight:500;">${ctaEn}</span>
              </a>
            </td>
          </tr>
          <!-- English body -->
          <tr>
            <td dir="ltr" style="padding:16px 32px 8px;text-align:left;border-top:1px solid #e2e8f0;">
              <p style="margin:16px 0 12px;color:#0F172A;font-size:16px;font-weight:700;line-height:1.5;">${greetingEn}</p>
              <p style="margin:0 0 16px;color:#334155;font-size:14px;line-height:1.7;">${bodyEn}</p>
            </td>
          </tr>
          <!-- Fallback link -->
          <tr>
            <td dir="ltr" style="padding:0 32px 24px;text-align:left;">
              <p style="margin:0;color:#64748b;font-size:12px;line-height:1.6;">
                ...
                <a href="${inviteUrl}" style="color:#0369A1;word-break:break-all;">${inviteUrl}</a>
              </p>
            </td>
          </tr>
          <!-- Footer -->
