...
// The instalment calculus lives in sales-installments.ts (pure, mirrored by
// the mobile app verbatim); re-exported here so web imports are unchanged.
export {
...
} from "./sales-installments"
import { installmentStates, isFullyPaid, paidSoFar, collectInstallments, applyInstallmentPayment, type InstallmentState, type InstallmentDue } from "./sales-installments"
