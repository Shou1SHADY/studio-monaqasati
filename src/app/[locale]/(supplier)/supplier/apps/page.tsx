...
// quick-switch dropdown in the top bar. Same component registry (mirrors
// the contractor /contractor/apps page), larger cards with a short
// description each.
export default function SupplierAppsPage() {
