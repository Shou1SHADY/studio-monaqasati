            ...
            <div className="flex flex-col md:flex-row items-center gap-10 flex-1">
              ...
              <div className="text-center md:text-right space-y-4">
                <div className="space-y-1">
                  ...
                  <h1 className="text-4xl lg:text-5xl font-black text-slate-900 font-headline tracking-tighter leading-none">{profile.name || "مدير النظام"}</h1>
                </div>
          ...
          <TabsContent value="basic" className="m-0 focus-visible:outline-none">
            <Card className="shadow-sm border-slate-200">
              <CardHeader className="pb-4">
                ...
                <CardDescription>البيانات الأساسية لمدير النظام</CardDescription>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="name" className="text-slate-700 font-bold">الاسم الكامل <span className="text-destructive mx-1">*</span></Label>
                      <Input 
                        id="name" 
                        value={profile.name}
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="phone" className="text-slate-700 font-bold">رقم الجوال</Label>
          ...
          <TabsContent value="security" className="m-0 focus-visible:outline-none">
            <Card className="shadow-sm border-slate-200">
              <CardHeader className="pb-4">
                ...
                <CardDescription>إدارة أمان حسابك والتحقق بخطوتين</CardDescription>
              </CardHeader>
              <CardContent className="p-6 space-y-6">
