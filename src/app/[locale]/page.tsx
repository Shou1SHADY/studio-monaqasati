  ...
  return (
    <div className="min-h-screen bg-[#020617] flex flex-col font-body text-foreground overflow-x-hidden selection:bg-cta/30">
      ...
      <main className="relative">
        ...
        <section className="relative overflow-hidden border-y border-white/5 bg-[#020617]">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch min-h-[700px]">
            <div className="relative overflow-hidden group">
              <img src="/images/warehouse-standing.jpg" alt="Contractor" className="w-full h-full object-cover transition-transform duration-3000 group-hover:scale-110" />
        ...
        <section className="relative overflow-hidden bg-[#020617]">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch min-h-[700px]">
            ...
            <div className="relative overflow-hidden group order-1 lg:order-2">
              <img src="/images/supplier-dashboard.jpg" alt="Supplier" className="w-full h-full object-cover transition-transform duration-3000 group-hover:scale-110" />
        ...
        {/* TESTIMONIALS - B2B Social Proof */}
        {/* Temporarily commented out — will be enabled when client testimonials are collected */}
        {/* <section className="py-16 md:py-24 bg-[#0F172A] relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-cta/20 to-transparent" />
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16 space-y-4">
              <p className="text-sky-400 font-black text-xs uppercase tracking-widest">
                {tLanding('Testimonials')}
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 backdrop-blur-sm relative group hover:bg-white/[0.04] transition-all">
                <Star size={14} className={cn("text-amber-400 fill-amber-400 absolute top-6 opacity-60", locale === 'ar' ? 'left-6' : 'right-6')} />
                <p className="text-slate-300 text-base leading-relaxed mb-6 font-medium">
                  {tLanding('Testimonial1Text')}
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-cta/20 flex items-center justify-center text-sky-400 font-black text-lg border border-cta/20">
                    {tLanding('Testimonial1Initial')}
                  </div>
                  <div>
                    <p className="text-white font-bold text-sm">{tLanding('Testimonial1Name')}</p>
                    <p className="text-slate-500 text-xs font-medium">{tLanding('Testimonial1Role')}</p>
                  </div>
                </div>
              </div>
              <div className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 backdrop-blur-sm relative group hover:bg-white/[0.04] transition-all">
                <Star size={14} className={cn("text-amber-400 fill-amber-400 absolute top-6 opacity-60", locale === 'ar' ? 'left-6' : 'right-6')} />
                <p className="text-slate-300 text-base leading-relaxed mb-6 font-medium">
                  {tLanding('Testimonial2Text')}
                </p>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-sky-500/20 flex items-center justify-center text-sky-400 font-black text-lg border border-sky-500/20">
                    {tLanding('Testimonial2Initial')}
                  </div>
                  <div>
                    <p className="text-white font-bold text-sm">{tLanding('Testimonial2Name')}</p>
                    <p className="text-slate-500 text-xs font-medium">{tLanding('Testimonial2Role')}</p>
                  </div>
                </div>
              </div>
            </div>
