      ...
      <DialogContent dir={locale === "ar" ? "rtl" : "ltr"} className="max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {t("crm_handover_title")}
          </DialogTitle>
          <DialogDescription>{t("crm_handover_desc")}</DialogDescription>
        </DialogHeader>

        <form className="space-y-4 py-2" onSubmit={(e) => { e.preventDefault(); void handleSubmit() }}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2 space-y-1.5">
              <Label htmlFor="ho-contract">{t("crm_handover_contract_number")} *</Label>
