...
import { Warehouse, Plus, Pencil, Trash2, Loader2, MapPin, Package, AlertTriangle } from "lucide-react"
        ...
        <div className="space-y-4 py-2">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="item-qty" type="number" min="0" value={quantity}
                onChange={(e) => setQuantity(e.target.value)} dir="ltr" />
            </div>
            <div className="space-y-1.5">
...
/**
 * Shared inventory-item CRUD UI for a single warehouse. Used both by the standalone
 * warehouse detail page ("full" — includes its own header) and embedded as a project's
 * "Warehouse" tab ("embedded" — the surrounding page already provides page-level chrome).
 */
